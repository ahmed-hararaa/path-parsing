...
namespace Test;
public class TestPathProxy : IPathProxy
{
...
{
    private void AssertValidPath(string input)
    {
        var proxy = new TestPathProxy();
        // These shouldn't throw or assert
        SvgPathParser.WriteSvgPathDataToPath(input, proxy);
        Assert.True(proxy.Called);
    }

    private void AssertInvalidPath(string input)
    {
        Assert.Throws<InvalidOperationException>(() => SvgPathParser.WriteSvgPathDataToPath(input, new TestPathProxy()));
    }
...
20.7195,11.68641 24.74134,11.68641 24.74134,10.34618 19.0281,10.34618 	z");
    ...
    [Test]
    public void MissingCommandsNumbersFlags()
    {
    ...
    [Test]
    public void CheckCharacterConstants()
    {
        Assert.AreEqual('\t', (char)AsciiConstants.SlashT);
        Assert.AreEqual('\n', (char)AsciiConstants.SlashN);
        Assert.AreEqual('\f', (char)AsciiConstants.SlashF);
        Assert.AreEqual('\r', (char)AsciiConstants.SlashR);
        Assert.AreEqual(' ', (char)AsciiConstants.Space);
        Assert.AreEqual('.', (char)AsciiConstants.Period);
        Assert.AreEqual('+', (char)AsciiConstants.Plus);
        Assert.AreEqual(',', (char)AsciiConstants.Comma);
        Assert.AreEqual('-', (char)AsciiConstants.Minus);
        Assert.AreEqual('0', (char)AsciiConstants.Number0);
        Assert.AreEqual('1', (char)AsciiConstants.Number1);
        Assert.AreEqual('2', (char)AsciiConstants.Number2);
        Assert.AreEqual('3', (char)AsciiConstants.Number3);
        Assert.AreEqual('4', (char)AsciiConstants.Number4);
        Assert.AreEqual('5', (char)AsciiConstants.Number5);
        Assert.AreEqual('6', (char)AsciiConstants.Number6);
        Assert.AreEqual('7', (char)AsciiConstants.Number7);
        Assert.AreEqual('8', (char)AsciiConstants.Number8);
        Assert.AreEqual('9', (char)AsciiConstants.Number9);
        Assert.AreEqual('A', (char)AsciiConstants.UpperA);
        Assert.AreEqual('C', (char)AsciiConstants.UpperC);
        Assert.AreEqual('E', (char)AsciiConstants.UpperE);
        Assert.AreEqual('H', (char)AsciiConstants.UpperH);
        Assert.AreEqual('L', (char)AsciiConstants.UpperL);
        Assert.AreEqual('M', (char)AsciiConstants.UpperM);
        Assert.AreEqual('Q', (char)AsciiConstants.UpperQ);
        Assert.AreEqual('S', (char)AsciiConstants.UpperS);
        Assert.AreEqual('T', (char)AsciiConstants.UpperT);
        Assert.AreEqual('V', (char)AsciiConstants.UpperV);
        Assert.AreEqual('Z', (char)AsciiConstants.UpperZ);
        Assert.AreEqual('a', (char)AsciiConstants.LowerA);
        Assert.AreEqual('c', (char)AsciiConstants.LowerC);
        Assert.AreEqual('e', (char)AsciiConstants.LowerE);
        Assert.AreEqual('h', (char)AsciiConstants.LowerH);
        Assert.AreEqual('l', (char)AsciiConstants.LowerL);
        Assert.AreEqual('m', (char)AsciiConstants.LowerM);
        Assert.AreEqual('q', (char)AsciiConstants.LowerQ);
        Assert.AreEqual('s', (char)AsciiConstants.LowerS);
        Assert.AreEqual('t', (char)AsciiConstants.LowerT);
        Assert.AreEqual('v', (char)AsciiConstants.LowerV);
        Assert.AreEqual('x', (char)AsciiConstants.LowerX);
        Assert.AreEqual('z', (char)AsciiConstants.LowerZ);
        Assert.AreEqual('~', (char)AsciiConstants.Tilde);
    }
}